...
<template>
    ...
    <div style="width: 100%; height: 100%;">
        ...
        <div id="navBar" style="display: flex; justify-content: space-between;">
            <div style="font-weight: 800; padding-left: 0px;position: absolute; font-family: Rajdhani; font-size: 30px; top: -3px">
                    ReUX
                    <!-- <span id="version">
            ...
            <div style="position: absolute; right: 10px; top: -3px;"><el-button text bg type="primary" @click="startEyeTag = !startEyeTag"><div style="font-family: Rajdhani; font-size: 16px; font-weight: 800">Start</div></el-button> <el-button text bg type="success" @click="saveData()"><div style="font-family: Rajdhani; font-size: 16px; font-weight: 800">Save</div></el-button> <el-button text bg type="danger" @click="endStudy()"><div style="font-family: Rajdhani; font-size: 16px; font-weight: 800">End</div></el-button>
                <el-button text bg @click="refreshPage()"><div style="font-family: Rajdhani; font-size: 16px; font-weight: 800">Refresh</div></el-button></div>
        </div>
